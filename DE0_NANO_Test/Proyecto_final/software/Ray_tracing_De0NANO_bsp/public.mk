...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../PROYECT_FINAL.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2002200
SOPC_SYSID_FLAG += --sidp=0x2002200
ELF_PATCH_FLAG  += --sidp 0x2002200

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1449292373
SOPC_SYSID_FLAG += --timestamp=1449292373
ELF_PATCH_FLAG  += --timestamp 1449292373
