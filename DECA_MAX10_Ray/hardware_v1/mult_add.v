...
`endif
	...
	wire [65:0] sub_wire8;
	wire [31:0] sub_wire7 = datab_2[31:0];
	wire [31:0] sub_wire6 = datab_1[31:0];
	wire [31:0] sub_wire3 = dataa_2[31:0];
	wire [31:0] sub_wire2 = dataa_1[31:0];
	wire [31:0] sub_wire0 = dataa_0[31:0];
	wire [95:0] sub_wire1 = {sub_wire3, sub_wire2, sub_wire0};
	wire [31:0] sub_wire4 = datab_0[31:0];
	wire [95:0] sub_wire5 = {sub_wire7, sub_wire6, sub_wire4};
	wire [65:0] result = sub_wire8[65:0];
